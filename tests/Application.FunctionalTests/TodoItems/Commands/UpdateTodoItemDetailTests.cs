using SurveillanceCameras.Application.TodoItems.Commands.CreateTodoItem;
using SurveillanceCameras.Application.TodoItems.Commands.UpdateTodoItem;
using SurveillanceCameras.Application.TodoItems.Commands.UpdateTodoItemDetail;
using SurveillanceCameras.Application.TodoLists.Commands.CreateTodoList;
using SurveillanceCameras.Domain.Entities;
using SurveillanceCameras.Domain.Enums;

namespace SurveillanceCameras.Application.FunctionalTests.TodoItems.Commands;
